...
class ImageEncoder(torch.nn.Module):
    def __init__(self, model, device="cpu", keep_lang=False, jit=False):
        super().__init__()
...
def get_context_weights(clip_model, template, classnames):
    # FIXME: 用于获取初始spj，即context_weights，大小为[num_templates, embed_dim]
